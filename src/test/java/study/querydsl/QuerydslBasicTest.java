...
public class QuerydslBasicTest {
    ...
    private List<Member> searchMember1(String usernameCond, Integer ageCond) {
        BooleanBuilder builder = new BooleanBuilder(/*member.user.eq(usernameCond)*/); //초기값 세팅(값이 무조건 있다고 할 경우)
    ...
    public void bulkUpdate() {
        ...
        // 초기화하지 않으면 영속성 컨테스트와 DB 내의 값이 다름
        // DB에는 비회원, 비회원, 멤버3, 멤버4
        // 영속성 컨테스트에는 멤버1, 멤버2, 멤버3, 멤버4
        em.flush();
        em.clear();
    }
